...
PolynomialTraj minSnapTraj(const Eigen::MatrixXd& Pos,
...
PolynomialTraj fastLine4deg(Eigen::Vector3d start, Eigen::Vector3d end,
  ...
  Eigen::Vector3d p1 =
      p0 + v0 * t1 + (1 / 2.0) * a0 * pow(t1, 2) + (1 / 6.0) * j0 * pow(t1, 3);
  ...
  Eigen::Vector3d p2 =
      p1 + v1 * t2 + (1 / 2.0) * a1 * pow(t2, 2) + (1 / 6.0) * j1 * pow(t2, 3);
  ...
  Eigen::Vector3d p3 =
      p2 + v2 * t3 + (1 / 2.0) * a2 * pow(t3, 2) + (1 / 6.0) * j2 * pow(t3, 3);
  ...
  Eigen::Vector3d p4 =
      p3 + v3 * t4 + (1 / 2.0) * a3 * pow(t4, 2) + (1 / 6.0) * j3 * pow(t4, 3);
  ...
  Eigen::Vector3d p5 =
      p4 + v4 * t5 + (1 / 2.0) * a4 * pow(t5, 2) + (1 / 6.0) * j4 * pow(t5, 3);
  ...
  Eigen::Vector3d p6 =
      p5 + v5 * t6 + (1 / 2.0) * a5 * pow(t6, 2) + (1 / 6.0) * j5 * pow(t6, 3);
