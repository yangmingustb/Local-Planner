...
double EDTEnvironment::distToBox(int idx, const Eigen::Vector3d& pos,
                                 const double& time) {
...
double EDTEnvironment::minDistToAllBox(const Eigen::Vector3d& pos,
                                       const double& time) {
...
pair<double, Eigen::Vector3d> EDTEnvironment::evaluateEDTWithGrad(
    const Eigen::Vector3d& pos, double time, double& dist,
    Eigen::Vector3d& grad) {
  Eigen::Vector3d diff;
