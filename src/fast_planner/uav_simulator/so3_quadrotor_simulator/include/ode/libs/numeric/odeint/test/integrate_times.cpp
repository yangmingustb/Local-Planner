...
BOOST_AUTO_TEST_CASE(test_integrate_times) {
  ...
  // controlled stepper
  integrate_times(controlled_runge_kutta<runge_kutta_dopri5<state_type> >(),
                  lorenz, x, boost::counting_iterator<int>(0),
                  boost::counting_iterator<int>(10), dt, push_back_time(times));
...
BOOST_AUTO_TEST_CASE(test_integrate_times_ranges) {
  ...
  // simple stepper
  integrate_times(runge_kutta4<state_type>(), lorenz, x,
                  std::make_pair(boost::counting_iterator<int>(0),
  ...
  // controlled stepper
  integrate_times(controlled_runge_kutta<runge_kutta_dopri5<state_type> >(),
                  lorenz, x, std::make_pair(boost::counting_iterator<int>(0),
                                            boost::counting_iterator<int>(10)),
                  dt, push_back_time(times));
