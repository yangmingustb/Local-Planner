...
void check_error_stepper_concept(Stepper &stepper, System system,
  ...
  stepper.do_step(
      system, typename boost::add_reference<container_type>::type(x), 0.0, 0.1);
  stepper.do_step(
      system, typename boost::add_reference<container_type>::type(x), 0.0, 0.1,
...
struct perform_error_stepper_test<Stepper, vector_type> {
  void operator()(void) {
    ...
    check_error_stepper_concept(
        ...
        xerr);
    check_error_stepper_concept(
        stepper, boost::cref(constant_system_functor_standard()), x, xerr);
...
struct perform_error_stepper_test<Stepper, vector_space_type> {
  void operator()(void) const {
    ...
    check_error_stepper_concept(
        ...
        x, xerr);
    check_error_stepper_concept(
        stepper, boost::cref(constant_system_functor_vector_space()), x, xerr);
...
typedef mpl::copy<
    ...
    mpl::inserter<mpl::vector0<>,
                  mpl::insert_range<mpl::_1, mpl::end<mpl::_1>,
                                    error_stepper_methods<mpl::_2> > > >::type
