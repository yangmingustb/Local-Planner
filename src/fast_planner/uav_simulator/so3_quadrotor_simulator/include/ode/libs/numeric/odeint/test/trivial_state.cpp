...
typedef mpl::vector<
    euler<state_type, value_type, deriv_type, time_type, vector_space_algebra,
    ...
    runge_kutta4<state_type, value_type, deriv_type, time_type,
                 ...
                 never_resizer> >::type stepper_types;
...
typedef mpl::vector<runge_kutta_cash_karp54<state_type, value_type, deriv_type,
                                            time_type, vector_space_algebra,
                                            default_operations, never_resizer>,
                    runge_kutta_dopri5<state_type, value_type, deriv_type,
                                       time_type, vector_space_algebra,
                                       default_operations, never_resizer> >
    error_stepper_types;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_integrate, T, error_stepper_types) {
  ...
  time_type t1 = 1.0;
  time_type dt = 0.1;
  integrate_adaptive(make_controlled<stepper_type>(1e-6, 1e-6), constant_system,
                     x, t0, t1, dt);
